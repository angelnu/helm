...
{{- define "cockroach.scName" -}}
  {{- default (include "cockroach.fullname" .|lower) .Values.scName -}}
{{- end -}}

{{- define "cockroach.basePath" -}}
  {{- default (printf "/media/openebs/local/%s" (include "cockroach.scName" .)) .Values.basePath -}}
{{- end -}}
